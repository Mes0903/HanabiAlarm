...
public:
	...
	// Task path: \Alarm\<label> <id>  (or "unnamed <id>" when label is empty)
	...
	// Deletes ALL tasks inside the \Alarm\ folder (including any orphans not in alarms.json).
	// Tasks outside \Alarm\ are never touched.
